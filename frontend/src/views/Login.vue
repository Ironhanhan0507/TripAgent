    ...
    <div class="w-full max-w-md">
      <div class="rounded-3xl border border-slate-100 bg-white p-8 shadow-xl shadow-brand-900/5">
        <div class="flex flex-col items-center">
          ...
          <h1 class="mt-4 text-2xl font-bold tracking-tight text-slate-900">欢迎回来</h1>
          <p class="mt-1 text-sm text-slate-400">登录 TripAgent，继续你的旅程</p>
        </div>
        ...
        <div class="mt-6 text-center text-sm text-slate-400">
          还没有账号？
          <router-link to="/register" class="font-medium text-brand-600 hover:text-brand-700">立即注册</router-link>
        </div>
      </div>
